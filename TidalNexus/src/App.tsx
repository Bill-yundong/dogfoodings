...
import { initDB, saveHistoricalRecords, tidalDataToHistoricalRecord, locationToId, getRecordCount, saveLocationAnalysis } from './db/tidalDB';
...
const App: React.FC = () => {
  ...
  const generateData = () => {
    ...
    saveHistoricalRecords(records).then(updateRecordCount);
  };
